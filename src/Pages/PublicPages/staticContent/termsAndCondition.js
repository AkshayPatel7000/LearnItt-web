...
const TermsAndCondition = () => {
    return (
        <div style={{ background: "#FFFFFF" }} className="p-2">
            <div className="p-5">
                <div>
                    <RobotoPrivacyHeading1 text="TERMS & CONDITIONS" />
                </div>

                <p className="privacyText mt-2">Updated at May 5th, 2023</p>

                <div className="mt-3">
                    <RobotoPrivacyTitelHeading1 text="General Terms" />
                </div>

                <div className="mt-3">
                    <p className="privacyText">
                        By accessing and placing an order with KRACKITT, you confirm that
                        ...
                        communication between you and KRACKITT.
                    </p>
                    <p className="privacyText">
                        Under no circumstances shall KRACKITT team be liable for any direct,
                        ...
                        KRACKITT team or an authorized representative has been advised of
                    ...
                    <p className="privacyText">
                        KRACKITT will not be responsible for any outcome that may occur
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="License" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT grants you a revocable, non-exclusive, non-transferable,
                            limited license to download, install and use the website/app
                            strictly in accordance with the terms of this Agreement.
                        </p>
                        <p className="privacyText">
                            These Terms & Conditions are a contract between you and KRACKITT
                            (referred to in these Terms & Conditions as "KRACKITT", "us", "we"
                            or "our"), the provider of the KRACKITT website and the services
                            accessible from the KRACKITT website (which are collectively
                            referred to in these Terms & Conditions as the "KRACKITT
                            Service").
                        </p>
                        <p className="privacyText">
                            ...
                            KRACKITT Service. In these Terms & Conditions, "you" refers both
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Definitions and key terms" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p className="privacyText">
                                        ...
                                        “our,” it refers to BRAINCORD EDUCATION PRIVATE LIMITED,
                                        (H-801 LABHAM RESIDENCY NEAR AGRAWAL PUBLIC SCHOOL INDORE
                                        452016), that is responsible for your information under this
                                        Terms & Conditions.
                                    </p>
                                </li>
                                <li>
                                    <p className="privacyText">
                                        {" "}
                                        Country: where KRACKITT or the owners/founders of KRACKITT
                                ...
                                <li>
                                    <p className="privacyText">
                                        ...
                                        visit KRACKITT and use the services.
                                    </p>
                                </li>
                                <li>
                                    <p className="privacyText">
                                        Service: refers to the service provided by KRACKITT as
                                ...
                                <li>
                                    <p className="privacyText">
                                        You: a person or entity that is registered with KRACKITT to
                                        use the Services.
                                    </p>
                                </li>
                            </ul>
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Restrictions" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p className="privacyText">
                                        ...
                                        any notice of copyright or trademark) of KRACKITT or its
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Payment" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            otherwise indicated in an order form, you must provide KRACKITT
                            with a valid credit card (Visa, MasterCard, or any other issuer
                            accepted by us) (“Payment Provider”) as a condition to signing up
                            ...
                            KRACKITT with your credit card number and associated payment
                            information, you agree that KRACKITT is authorized to verify
                            information immediately, and subsequently invoice your account for
                            all fees and charges due and payable to KRACKITT hereunder and
                            that no additional notice or consent is required. You agree to
                            immediately notify KRACKITT of any change in your billing address
                            or the credit card used for payment hereunder. KRACKITT reserves
                            the right at any time to change its prices and billing methods,
                            either immediately upon posting on our Site or by e-mail delivery
                            to your organization’s administrator(s).
                        </p>
                        <p className="privacyText">
                        ...
                        <p className="privacyText">
                            No contract will exist between you and KRACKITT for the Service
                            until KRACKITT accepts your order by a confirmatory e-mail,
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Return and Refund Policy" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            Thanks for shopping at KRACKITT. We appreciate the fact that you
                            like to buy the stuff we build. We also want to make sure you have
                            a rewarding experience while you are exploring, evaluating, and
                            purchasing our products.
                        </p>
                        <p className="privacyText">
                            As with any shopping experience, there are terms and conditions
                            that apply to transactions at KRACKITT. We’ll be as brief as our
                            attorneys will allow. The main thing to remember is that by
                            placing an order or making a purchase at KRACKITT, you agree to
                            the terms along with KRACKITT’s Privacy Policy.
                        </p>
                        <p className="privacyText">
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Your Suggestions" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            Any feedback, comments, ideas, improvements or suggestions
                            (collectively, "Suggestions") provided by you to KRACKITT with
                            respect to the website/app shall remain the sole and exclusive
                            property of KRACKITT. KRACKITT shall be free to use, copy, modify,
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Your Consent" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Links to Other Websites" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            KRACKITT. We are not responsible for the content, accuracy or
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Cookies" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT uses "Cookies" to identify the areas of our website/app
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Changes To Our Terms & Conditions" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            You acknowledge and agree that KRACKITT may stop (permanently or
                            temporarily) providing the Service (or any features within the
                            Service) to you or to users generally at KRACKITT sole discretion,
                            without prior notice to you. You may stop using the Service at any
                            time. You do not need to specifically inform KRACKITT when you
                            stop using the Service. You acknowledge and agree that if KRACKITT
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Modifications to Our website/app" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT reserves the right to modify, suspend or discontinue,
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Updates to Our website/app" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT reserves the right to modify, suspend or discontinue,
                        ...
                        <p className="privacyText">
                            ...
                            functionalities of the website/app. You agree that KRACKITT has no
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Third-Party Services" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                        ...
                        <p className="privacyText">
                            You acknowledge and agree that KRACKITT shall not be responsible
                            for any Third-Party Services, including their accuracy,
                            completeness, timeliness, validity, copyright compliance,
                            legality, decency, quality or any other aspect thereof. KRACKITT
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Term and Termination" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                        ...
                        <p className="privacyText">
                            KRACKITT may, in its sole discretion, at any time and for any or
                        ...
                        <p className="privacyText">
                            ...
                            from KRACKITT, in the event that you fail to comply with any
                        ...
                        <p className="privacyText">
                            Termination of this Agreement will not limit any of KRACKITT's
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Copyright Infringement Notice" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Indemnification" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            You agree to indemnify and hold KRACKITT and its parents,
                            ...
                            your: (a) use of the website/app; (b) violation of this Agreement
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="No Warranties" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            maximum extent permitted under applicable law, KRACKITT, on its
                            ...
                            with respect to the website/app, including all implied warranties
                            of merchantability, fitness for a particular purpose, title and
                            non-infringement, and warranties that may arise out of course of
                            dealing, course of performance, usage or trade practice. Without
                            limitation to the foregoing, KRACKITT provides no warranty or
                            ...
                            website/apps, systems or services, operate without interruption,
                            meet any performance or reliability standards or be error free or
                            that any errors or defects can or will be corrected.
                        </p>
                        <p className="privacyText">
                            Without limiting the foregoing, neither KRACKITT nor any
                            KRACKITT's provider makes any representation or warranty of any
                            kind, express or implied: (i) as to the operation or availability
                            of the website/app, or the information, content, and materials or
                            ...
                            KRACKITT are free of viruses, scripts, trojan horses, worms,
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Limitation of Liability" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            Notwithstanding any damages that you might incur, the entire
                            liability of KRACKITT and any of its suppliers under any provision
                        ...
                        <p className="privacyText">
                            ...
                            shall KRACKITT or its suppliers be liable for any special,
                            ...
                            Agreement), even if KRACKITT or any supplier has been advised of
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Severability" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                        ...
                        <p className="privacyText">
                            ...
                            legal notices published by KRACKITT on the Services, shall
                            constitute the entire agreement between you and KRACKITT
                            ...
                            term, and KRACKITT’s failure to assert any right or provision
                            under this Agreement shall not constitute a waiver of such right
                            or provision. YOU AND KRACKITT AGREE THAT ANY CAUSE OF ACTION
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Waiver" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Amendments to this Agreement" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT reserves the right, at its sole discretion, to modify or
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Entire Agreement" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            The Agreement constitutes the entire agreement between you and
                            KRACKITT regarding your use of the website/app and supersedes all
                            prior and contemporaneous written or oral agreements between you
                            and KRACKITT. You may be subject to additional terms and
                            conditions that apply when you use or purchase other KRACKITT's
                            services, which KRACKITT will provide to you at the time of such
                            use or purchase
                        </p>
                    </div>
                </div>
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Updates to Our Terms" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Intellectual Property" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            selection and arrangement thereof), are owned by KRACKITT, its
                            licensors or other providers of such material and are protected by
                            INDIA and international copyright, trademark, patent, trade secret
                            ...
                            prior written permission of KRACKITT, unless and except as is
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Agreement to Arbitrate" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR KRACKITT’s
                            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any
                            dispute, action, or page 8/10 other controversy between you and
                            KRACKITT concerning the Services or this agreement, whether in
                            contract, warranty, tort, statute, regulation, ordinance, or any
                            other legal or equitable basis. “Dispute” will be given the
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Notice of Dispute" />
                    </div>
                    <div className="mt-3">
                        In the event of a dispute, you or KRACKITT must give the other a
                        ...
                        braincordeducation@gmail.com. KRACKITT will send any Notice of
                        Dispute to you by mail to your address if we have it, or otherwise
                        to your email address. You and KRACKITT will attempt to resolve any
                        ...
                        KRACKITT may commence arbitration.
                    </div>
                </div>

                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Binding Arbitration" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            If you and KRACKITT don’t resolve any dispute by informal
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Submissions and Privacy" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            property of KRACKITT without any compensation or credit to you
                            whatsoever. KRACKITT and its affiliates shall have no obligations
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Promotions" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT may, from time to time, include contests, promotions,
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Typographical Errors" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Miscellaneous" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            ...
                            signed by an authorized representative of KRACKITT. KRACKITT will
                            ...
                            breach or anticipatory breach by you. KRACKITT operates and
                            controls the KRACKITT Service from its offices in INDIA. The
                            ...
                            persons who choose to access the KRACKITT Service from other
                            ...
                            are applicable. These Terms & Conditions (which include and
                            incorporate the KRACKITT Privacy Policy) contains the entire
                            understanding, and supersedes all prior understandings, between
                            you and KRACKITT concerning its subject matter, and cannot be
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Disclaimer" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                            KRACKITT is not responsible for any content, code or any other
                            imprecision.
                        </p>
                        <p className="privacyText">
                            KRACKITT does not provide warranties or guarantees.
                        </p>
                        <p className="privacyText">
                            In no event shall KRACKITT be liable for any special, direct,
                        ...
                        <p className="privacyText">
                            The KRACKITT Service and its contents are provided "as is" and "as
                            available" without any warranty or representations of any kind,
                            whether express or implied. KRACKITT is a distributor and not a
                            publisher of the content supplied by third parties; as such,
                            KRACKITT exercises no editorial control over such content and
                            makes no warranty or representation as to the accuracy,
                            reliability or currency of any information, content, service or
                            merchandise provided through or accessible via the KRACKITT
                            Service. Without limiting the foregoing, KRACKITT specifically
                            disclaims all warranties and representations in any content
                            transmitted on or in connection with the KRACKITT Service or on
                            sites that may appear as links on the KRACKITT Service, or in the
                            products provided as a part of, or otherwise in connection with,
                            the KRACKITT Service, including without limitation any warranties
                            of merchantability, fitness for a particular purpose or
                            non-infringement of third party rights. No oral advice or written
                            information given by KRACKITT or any of its affiliates, employees,
                            ...
                            notice. Without limiting the foregoing, KRACKITT does not warrant
                            that the KRACKITT Service will be uninterrupted, uncorrupted,
                ...
                <div>
                    <div className="mt-3">
                        <RobotoPrivacyTitelHeading1 text="Contact Us" />
                    </div>
                    <div className="mt-3">
                        <p className="privacyText">
                        ...
                        <div >
                            <ul>
                                <li>
                                    <p className="privacyText">
                                        Via Email: braincordeducation@gmail.com
                                    </p>
                                </li>
                                <li>
                                    <p className="privacyText">
                                        Via Phone Number: +91-9200425737
                                    </p>
                                </li>
                            </ul>
                        </div>
